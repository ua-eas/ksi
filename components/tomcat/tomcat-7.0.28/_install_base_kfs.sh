#
# component base install script for kfs on tomcat-7.0.28
#
...
export COMPONENT_BASE="${COMPONENT_BASE}/kfs"
export COMPONENT_LOGS="${COMPONENT_BASE}/logs"
export INSTALLER_COMPONENT_PROFILE_TMPL="${INSTALLER_COMPONENT_VERSIONDIR}/profile_kfs.sh.tmpl"
export COMPONENT_PROFILE="${COMPONENT_PROFILE}_kfs"
export INSTALLER_COMPONENT_INIT_TMPL="${INSTALLER_COMPONENT_VERSIONDIR}/init_kfs.sh.tmpl"
export COMPONENT_INIT="${COMPONENT_INIT}_kfs"
export TOMCAT_CATALINA_PID="${COMPONENT_LOGS}/catalina.pid"
export TOMCAT_THIS_INSTANCE="KFS"
...
#
# Copy KFS-specific environment variables into generic placeholders for templating.

echo "[-install-] Copying KFS-specific environment into generic Tomcat template variables ..."
...
#
# Make the base directory structure for the KFS instance.

echo "[-install-] Creating base directory structure for kfs tomcat instance  ..."
...
echo "[-install-] Creating environment settings file for kfs tomcat instance ..."
